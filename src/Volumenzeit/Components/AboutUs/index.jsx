...
function AboutUs() {
	...
	return (
		<div
			id="about"
			className="px-4 w-full max-w-[1440px] mx-auto overflow-hidden md:px-20 py-12 justify-between flex flex-col items-center md:flex-col lg:flex-row"
		>
			<div className="flex-1 ">
				<h2
					className="font-Space md:text-[42px] text-[28px] text-center sm:text-start md:text-center lg:text-start  mb-2"
					data-aos="fade-right"
				>
					ABOUT US
				</h2>
				<p
					className="text-[14px] text-center sm:text-start mt-6 sm:max-w-[400px] lg:max-w-[450px] md:max-w-[700px] font-light leading-7 sm:leading-7 text-[#939393] font-poppins"
					data-aos="fade-right"
				>
			...
			{/* Video poster */}
			<div
				className="mt-6 flex-1 relative w-full md:max-w-[600px] max-w-[300px] xs:max-w-[700px]  "
				data-aos="fade-left"
			>
				<div
			...
			{isVideoPlaying && (
				<div className="fixed inset-0 bg-opacity-50  bg-black  z-50 flex flex-col items-center justify-center ">
					<div className="relative w-full max-w-4xl rounded-lg bg-white px-6  md:px-24 pt-12 pb-4">
						...
						<ReactPlayer
							url={
								"https://www.youtube.com/watch?v=s-x_HVCwKgI&pp=ygURdm9sdW1lbnplaXQgd2F0Y2g%3D"
							}
							playing={true}
							controls={true}
							width="100%"
