	...
	return (
		<div className="">
			<Slider ref={sliderRef} {...settings}>
				<div>
					<WatchCard
						img={blueEmbroideWatch}
						price="$20,588"
						volumenzeit="Volumenzeit S 8"
					/>
				</div>
				<div>
					<WatchCard
			...
			<div className="flex justify-between items-center max-w-[90vw] mx-auto flex-col md:flex-row px-2  gap-4 mt-6">
				<div className=" flex gap-2">
					...
					>
						<img
							src={leftArrow}
							alt="leftArrow"
							className="transition-transform duration-300 hover:scale-95 w-12 md:w-16 h-auto"
						/>
					</button>
					<button
				...
				<button
					className="text-white text-[12px] bg-[#745cff] font-poppins  px-12 py-6 rounded hover:bg-gray-800"
					data-aos="fade-right"
					data-aos-once="false"
				>
					Design Your Watch
