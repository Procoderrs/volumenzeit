			...
			>
				...
				<div className="flex-[2]  py-28 bg-black px-4  lg:px-4   flex flex-col  items-center lg:items-center justify-center">
					<div className="font-poppins flex      md:items-center  lg:items-start items-center flex-col text-white ">
						<h2
							className="font-Space text-white      text-center  sm:text-[42px] text-[28px]"
							data-aos="fade-left"
						>
							OUR Mission
						</h2>
						...
						<p
							className="  mt-4 text-sm text-[#dedede]   font-extralight leading-7  lg:text-start text-center  font-poppins max-w-[500px] md:max-w-[800px]  lg:max-w-[400px]"
							data-aos="fade-left"
						>
						...
						<p
							className="mt-8 max-w-[700px] text-[#dedede] font-extralight font-poppins  lg:max-w-[400px] lg:text-start md:text-center text-center text-[14px]"
							data-aos="fade-left"
						>
						...
						<button
							className=" text-[14px] text-center mt-8 bg-[#745cff] px-8 py-4 rounded transition-all duration-300 ease-in-out hover:bg-black hover:text-white hover:border-b-2"
							data-aos="fade-left"
						>
							Design Your Watch
						</button>
