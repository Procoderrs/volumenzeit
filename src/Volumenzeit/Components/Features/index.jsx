...
const featuresContent = (
	<>
		...
		<p>
			Dial Color: Black Metallic Color shiftingBlue-purple,
...
const FeatureBlock = ({ title, content, position, side }) => (
	<div className={`feature-block ${side} relative`} data-aos="fade-left">
		...
		<div className={`font-poppins flex flex-col justify-center`}>
			<h2 className="feature-title text-lg mb-4 relative">{title}</h2>
			<div
				className={`text-[10px] ${
...
function Features() {
	...
	const getFeatureContent = (title) => {
		switch (title) {
			case "Individual Style":
				return individualStyleContent;
			case "Features":
	...
	return (
		<div className="py-12">
			<div
				id="features"
				className="font-poppins w-full  mx-auto flex flex-col px-4 items-center"
			>
				<h2
					className="md:text-[40px] text-[28px]  font-Space"
					data-aos="fade-up"
				>
					Features
				</h2>
				...
				<div className="xl:hidden ">
					<div className="relative flex flex-col md:flex-row items-center justify-center">
						<div
							className="relative w-[300px] px-6 md:sticky md:top-[-200px]  mt-24 h-68 flex items-center justify-center md:mt-0"
							data-aos="fade-up"
						>
							<img
								src={circle}
								alt="circle"
								className="absolute w-full  object-cover animate-spin-slow"
							/>
							<img
								src={watchFeatures}
								alt="watch"
						...
						<div className="  space-y-12">
							{["Individual Style", "Features", "High Quality Components"].map(
								(title, idx) => (
									<div
										key={title}
										className="flex  mt-24 flex-col items-center"
									...
									>
										...
										<h2
											className="feature-title-mobile text-[18px] mb-4 mt-4  relative"
											data-aos="fade-left"
										>
											{title}
										</h2>
										<div
											className="text-[10px] px-4 font-poppins  font-light leading-6 text-[#939393] text-center"
											data-aos="fade-left"
										>
