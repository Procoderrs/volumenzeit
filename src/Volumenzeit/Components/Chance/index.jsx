...
function Chance() {
	...
	return (
		<div
			className="bg-cover bg-center py-12 bg-pink-400 w-full h-full overflow-hidden mx-auto px-4 relative text-white"
			style={{ backgroundImage: `url(${bg})` }}
		>
			<div className="flex flex-col">
				<div className="flex items-center flex-col justify-center">
					<h2
						className="font-poppins text-[28px] md:text-4xl leading-10 text-center font-bold"
						data-aos="fade-up"
					>
						Don't Miss Your Chance To Get Free Giveaway. Sign Up to Our
						Newsletter
					</h2>

					<p
						className="pt-12 font-poppins text-center text-[14px] leading-8 sm:text-[14px]"
						data-aos="fade-up"
					>
				...
				<div className="mt-8 flex items-center gap-6 font-poppins justify-center flex-col">
					...
					<div>
						<p
							className="text-white mt-6 text-[12px] font-poppins text-center"
							data-aos="fade-up"
						>
