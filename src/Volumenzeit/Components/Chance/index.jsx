...
<div className='flex items-center flex-col  justify-center'>
      <h2 className='font-poppins text-2xl md:text-4xl  leading-10 text-center font-bold' data-aos="fade-up">Don't Miss Your Chance To Get Free Giveaway. Sign Up to Our Newsletter</h2>

   <p className='pt-12 font-poppins text-center text-[14px] sm:text-[16px]' data-aos="fade-up">We will inform you about coming Giveaways, Offers, Online Store preparation progress and start of sales.</p>
